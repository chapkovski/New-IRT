...
class Constants(BaseConstants):
    ...
    reduce_income_difference_choices = [
        [1, _('Totally disagree')],
        [2, _('Somewhat disagree')],
        [3, _('Neither agree nor disagree')],
        [4, _('Somewhat agree')],
    ...
    income_choices = [
        ...
        [4, _('Enough money for small purchases, but buying expensive things (computer, washing machine, refrigerator) requires savings or credit')],
        [5, _('Have enough money to buy for the house, but to buy a car, dacha, apartment requires saving or taking a loan')],
        [6, _('Can afford any purchases without restrictions or credit')],
        HARD_TO_SAY_CHOICE
    ]

    regional_differences_choices = [
        [1, _('Absolutely agree')],
        [2, _('Somewhat agree')],
        [3, _('Neither agree nor disagree')],
        [4, _('Somewhat disagree')],
        [5, _('Totally disagree')],
        HARD_TO_SAY_CHOICE
    ]
...
class Player(BasePlayer):
    ...
    best_intensions = models.PositiveIntegerField(
    ...
    income_diff = models.PositiveIntegerField(
        ...
        choices=Constants.income_difference_choices,
        widget=widgets.RadioSelect()
    )
    ...
    fin_situation_change = models.CharField(
        blank=True,
    ...
    regional_diff = models.PositiveIntegerField(
        label=_('Do you agree with the statement that the differences in the level of income between the regions of Russia are unjustifiably large?'),
        choices=Constants.regional_differences_choices,
        widget=widgets.RadioSelect()
    )

    regional_income_changed = models.PositiveIntegerField(
        label=_('In your opinion, did the the average monthly income of the residents of your region change over the last year?'),
    ...
    #Patience_10
    Patience_10_1 = models.IntegerField(label=_('How willing are you to give up something that is beneficial for you today in order to benefit more from that in the future?'), choices=Constants.Patience_10, widget=widgets.RadioSelect)
    Patience_10_2 = models.IntegerField(label=_(' How willing are you to punish someone who treats others unfairly, even if there may be costs for you?'), choices=Constants.Patience_10, widget=widgets.RadioSelect)
    Patience_10_3 = models.IntegerField(label=_('When someone does me a favor, I am willing to return it'), choices=Constants.Patience_10, widget=widgets.RadioSelect)
    Patience_10_4 = models.IntegerField(label=_('If I have been treated unfairly, I will retaliate at the first opportunity, even if it costs me a lot'),
    ...
    #Yes/No questions
    donated_money = models.IntegerField(label=_('Have you donated money in the previous 12 months?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    count_on_relatives = models.IntegerField(label=_('Do you have relatives or friends you can count on to help you whenever needed?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    help_stranger = models.IntegerField(label=_('Did you help a stranger in the previous 12 months who needed help?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    self_employed = models.IntegerField(label=_('Are you self-employed?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    ...
    stolen_money = models.IntegerField(label=_('Has money or property been stolen from you or another household member within the last 12 months? '), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    used_trust = models.IntegerField(label=_('Did someone take advantage of your trust in the last 6 months?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    reciprocated_trust = models.IntegerField(label=_('Did you experience a positive response in the last 6 months when you trusted someone?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    disappointed_trust = models.IntegerField(label=_('Have you disappointed someone in the last 6 months who has trusted you?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)
    donated_blood = models.IntegerField(label=_('Did you donate blood during the last 6 months?'), choices=Constants.Yes_No, widget=widgets.RadioSelect)

# Big 5
    big5_1 = models.IntegerField(label=_('I see myself as someone who is reserved'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_2 = models.IntegerField(label=_('I see myself as someone who is generally trusting'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_3 = models.IntegerField(label=_('I see myself as someone who tends to be lazy'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_4 = models.IntegerField(label=_('I see myself as someone who is relaxed, handles stress well'),choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_5 = models.IntegerField(label=_('I see myself as someone who has few artistic interests'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_6 = models.IntegerField(label=_('I see myself as someone who is outgoing, sociable'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_7 = models.IntegerField(label=_('I see myself as someone who tends to find fault with others'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_8 = models.IntegerField(label=_('I see myself as someone who does a thorough job'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_9 = models.IntegerField(label=_('I see myself as someone who gets nervous easily'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_10 = models.IntegerField(label=_('I see myself as someone who has an active imagination'), choices=Constants.Big5, widget=widgets.RadioSelect)
    big5_11 = models.IntegerField(label=_('I see myself as someone who is reserved'), choices=Constants.Big5, widget=widgets.RadioSelect)