    ...
    def vars_for_template(self):
        items = [
            ...
            dict(name='lits_ownership',
                 left="Частная собственность в бизнесе и промышленности должна быть увеличена",
                 right="Государственная собственность в бизнесе и промышленности должна быть увеличена"),
            dict(name='lits_competition',
                 left="Конкуренция  это благо, поскольку она побуждает людей лучше трудиться и разрабатывать новые идеи",
                 right="Конкуренция вредна, поскольку она пробуждает у людей худшие качества"),
            ...
            dict(name='lits_wealthy',
                 left="Это не является проблемой, что богатые люди влияют на то, как правительство управляется в этой стране",
